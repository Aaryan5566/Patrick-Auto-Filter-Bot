...
auth_channel = environ.get('AUTH_CHANNEL', '-1002383920676')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002332256363'))
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002335308743'))
